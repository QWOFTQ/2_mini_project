...
public class kakaoPayment {
    ...
    public static String preparePayment(String amount) throws IOException {
        ...
        String params = "cid=TC0ONETIME" +
                ...
                "&total_amount=" + amount +
                "&tax_free_amount=0" +
                "&approval_url=https://fbdd-218-144-130-138.ngrok-free.app/success" +
                "&cancel_url=https://fbdd-218-144-130-138.ngrok-free.app/cancel" +
                "&fail_url=https://fbdd-218-144-130-138.ngrok-free.app/fail";
